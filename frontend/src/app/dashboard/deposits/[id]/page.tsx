        ...
        const fetchData = async () => {
            try {
                ...
                setFormData({
                    ...
                    verified_by_contact_id: deposit.verified_by_contact_id ? String(deposit.verified_by_contact_id) : '',
                    date_report_sent: deposit.date_report_sent ? deposit.date_report_sent.substring(0, 10) : '',
