...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen flex flex-col transition-all duration-300 shadow-2xl border-r border-border-subtle bg-surface">

            {/* Logo */}
            <div className="h-16 flex items-center px-5 gap-3 border-b border-border-subtle">
                <div className="relative">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-crm-500 to-blue-500">
            ...
            <div className="flex-1 py-5 px-3 space-y-0.5 overflow-y-auto">
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {isActive && (
                                <span className="absolute ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 w-1 h-5 rounded-r bg-crm-500" />
                            )}
                            <Icon className={clsx("w-4.5 h-4.5 relative z-10 flex-shrink-0",
                                isActive ? "text-crm-600 dark:text-crm-400" : "text-muted-text group-hover:text-foreground")} />
            ...
            <div className="p-3 border-t border-border-subtle">
                <div className="flex items-center justify-between px-2 py-2 rounded-xl border border-border-subtle bg-surface-hover">
                    ...
                    <button
                        ...
                        className="p-1.5 text-muted-text hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-all duration-200"
                        title="Log out"
                    >
