...
def import_contracts(db: Session):
    ...
    for row in ws.iter_rows(min_row=2, values_only=True):
        ...
        contract_data = {
            ...
            'beneficiary_management_contact': row_val(row, col, 'Beneficiary Management Contact', 'Management Contact (Beneficiary)', 'Management Contact'),
            'beneficiary_technical_contact': row_val(row, col, 'Beneficiary Technical Contact', 'Technical Contact (Beneficiary)', 'Technical Contact'),
            'beneficiary_financial_contact': row_val(row, col, 'Beneficiary Financial Contact', 'Financial Contact (Beneficiary)', 'Financial Contact'),
            'supplier_management_contact': row_val(row, col, 'Supplier Management Contact', 'Management Contact (Supplier)'),
            'supplier_technical_contact': row_val(row, col, 'Supplier Technical Contact', 'Technical Contact (Supplier)'),
            'supplier_financial_contact': row_val(row, col, 'Supplier Financial Contact', 'Financial Contact (Supplier)'),
        ...
        db.add(models.Contract(
            ...
            beneficiary_management_contact=contract_data['beneficiary_management_contact'],
            beneficiary_technical_contact=contract_data['beneficiary_technical_contact'],
            beneficiary_financial_contact=contract_data['beneficiary_financial_contact'],
            supplier_management_contact=contract_data['supplier_management_contact'],
            supplier_technical_contact=contract_data['supplier_technical_contact'],
            supplier_financial_contact=contract_data['supplier_financial_contact'],
