...
class Contract(Base):
    ...
    beneficiary_currency = Column(String(10), nullable=True, default="USD")
    beneficiary_set_up_fee = Column(String(255), nullable=True)
    beneficiary_annual_fee = Column(String(255), nullable=True)
    beneficiary_updates = Column(String(255), nullable=True)
    beneficiary_ext_verification = Column(String(255), nullable=True)
    supplier_currency = Column(String(10), nullable=True, default="USD")
    supplier_set_up_fee = Column(String(255), nullable=True)
    supplier_annual_fee = Column(String(255), nullable=True)
    supplier_updates = Column(String(255), nullable=True)
    supplier_ext_verification = Column(String(255), nullable=True)
